...
/** @defgroup B_L475E_IOT01A2 B_L475E_IOT01A2
 * @{
 */

/** @defgroup B_L475E_IOT01A2_LOW_LEVEL B_L475E_IOT01A2 LOW LEVEL
...
/** @defgroup B_L475E_IOT01A2_LOW_LEVEL_Private_Defines B_L475E_IOT01A2 LOW LEVEL Private Defines
 * @{
 */

/** @defgroup B_L475E_IOT01A2_LOW_LEVEL_FunctionPrototypes B_L475E_IOT01A2 LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup B_L475E_IOT01A2_LOW_LEVEL_Private_Variables B_L475E_IOT01A2 LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__B_L475E_IOT01A2_BSP_VERSION;
}
 ...
 * @retval None
 */
static void I2Cx_DeInit(I2C_HandleTypeDef *i2c_handler) { /* DeInit the I2C */
