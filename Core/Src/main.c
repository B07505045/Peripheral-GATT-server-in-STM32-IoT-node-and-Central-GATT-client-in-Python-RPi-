...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of thread1 */
  thread1Handle = osThreadNew(Task1, NULL, &thread1_attributes);

  /* creation of thread2 */
  thread2Handle = osThreadNew(Task2, NULL, &thread2_attributes);
